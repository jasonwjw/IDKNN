...
from ScanObjectNNDataLoader import ScanObjectNNDataLoader
from ptaug_utils import transform_point_cloud, scale_point_cloud, get_aug_args
from pointnet2_utils import sample
from utils import get_model, get_loss, set_seed, weight_init
from repsurf_ssg_umb_2x import Model
...
def parse_args():
    ...
    parser.add_argument('--model', default='repsurf_ssg_umb_2x',
    ...
    # Training
    parser.add_argument('--batch_size', type=int, default=48, help='batch size in training [default: 64]')
...
def main(args):
    ...
    if args.log_dir is None:
        timestr = str(datetime.datetime.now().strftime('%Y-%m-%d_%H-%M')) + '2x-112'
