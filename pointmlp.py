...
def knn_point_wjw(k, points, new_points,d):
    """
    Input:
        nsample: max sample number in local region
        xyz: all points, [B, N, C]
    ...
    Return:
        group_idx: grouped points index, [B, S, nsample]
    """
    sqrdists = square_distance(new_points, points)  #b,s,n
    w = k // d
...
class LocalGrouper(nn.Module):
    def __init__(self, channel, groups, kneighbors, use_xyz=True, normalize="center", d = 1,**kwargs):
        """
...
#change by wjw !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
 #       idx = knn_point(self.kneighbors, xyz, new_xyz)
        #idx = knn_point_wjw(self.kneighbors,points,new_points,self.d)
        idx = knn_point_wjw(self.kneighbors,xyz,new_xyz,self.d)
...
#            else:
#                d = 1
            local_grouper = LocalGrouper(last_channel, anchor_points, kneighbor, use_xyz, normalize,d = 1) # [b,g,k,d]
