...
from pointnet2_utils import farthest_point_sample, index_points, query_knn_point, query_ball_point,query_knn_point_wjw
from polar_utils import xyz2sphere
from recons_utils import cal_const, cal_normal, cal_center, check_nan_umb


def sample_and_group(d,npoint, radius, nsample, center, normal, feature, return_normal=True, return_polar=False, cuda=False):
    """
    Input:
    ...
    # group
    # change by wjw to test dknn
    # idx = query_ball_point(radius, nsample, center, new_center, cuda=cuda)

    idx = query_knn_point_wjw(d,nsample,center,new_center,cuda=cuda)
    # idx = query_knn_point(nsample,center,new_center,cuda=cuda)
...
class SurfaceAbstractionCD(nn.Module):
    ...
    def __init__(self,d, npoint, radius, nsample, feat_channel, pos_channel, mlp, group_all,
    ...
    def forward(self, center, normal, feature):
        ...
        if self.group_all:
            ...
            new_center, new_normal, new_feature = sample_and_group(self.d,self.npoint, self.radius, self.nsample, center,
